...
class ErrorQRCodeInfo extends StatefulWidget {
  QRDetails qrDetails;
  User user;

  ErrorQRCodeInfo({this.qrDetails, this.user});

  @override
  _QRCodeInfoState createState() => _QRCodeInfoState(qrDetails, user);
}

class _QRCodeInfoState extends State<ErrorQRCodeInfo> {
          ...
          child: Container(
            child: ListView(
              ...
              children: <Widget>[
                ...
                Column(
                  children: <Widget>[
                    _qrDetails.status == "8" ? Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(

                        'It was scanned on ${new DateFormat.yMMMMd("en_US").format(DateTime.parse(_qrDetails.when))}, ${new DateFormat.jm().format(DateTime.parse(_qrDetails.when))} by ${_qrDetails.who} at gate ${_qrDetails.gateName}.',
